  ...
  return (
    <LayoutContainer>
      <PageHeader
        ...
        description="Planifier un nouveau chantier"
      />
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  {clients.length === 0 && !loadingClients && (
                    <p className="text-sm text-muted-foreground">
                      Aucun client. <button type="button" onClick={() => router.push('/dashboard/clients/new')} className="text-primary underline">Créer un client</button>
                    </p>
                  )}
                </div>
